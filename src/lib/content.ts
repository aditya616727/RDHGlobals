...
export const themeContent = {
  food: {
    ...
    aboutP1: "RVDH Globals Every batch is sourced directly from partner farms, graded in-house, and packed to the specification of the buyer — no intermediaries, no inconsistency.",
    ...
    makhanaProducts: [
      { name: "Raw Makhana (5 & 6 Suta)", img: "/images/premium_makhana.png" },
      { name: "Roasted Pink Salt Makhana", img: "/images/rosted_makhana.png" },
      { name: "Peri Peri Spiced Fox Nuts", img: "/images/peri_peri.png" },
      { name: "Chocolate Coated Makhana", img: "/images/chocolate.png" },
      { name: "Cheese & Herbs Makhana", img: "/images/cheese.png" },
      { name: "Cream & Onion Makhana", img: "/images/onion_cream.png" },
      { name: "Pudina Mint Makhana", img: "/images/pudina.png" },
      { name: "Commercial Grade Makhana", img: "/images/makhana.png" },
    ],
    amlaProducts: [
      { name: "Fresh Organic Amla", img: "/images/fresh_amla.jpg" },
      { name: "Sweet & Tangy Amla Candy", img: "/images/amla_candy.jpg" },
      { name: "Pure Organic Amla Powder", img: "/images/amla_powder.jpg" },
      { name: "100% Pure Cold-Pressed Amla Juice", img: "/images/amla_juice.jpg" },
    ],
    defaultProducts: [
      { name: "Raw Makhana", img: "/images/premium_makhana.png" },

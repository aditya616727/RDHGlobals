...
export const DEFAULT_PRODUCTS: ProductItem[] = [
  ...
  },
  {
    ...
    sortOrder: 9,
    images: [
      { url: '/images/fresh_amla.jpg', alt: 'Fresh Organic Indian Amla Gooseberry', isPrimary: true }
    ]
  },
  {
    id: 'prod-food-10',
    ...
    sortOrder: 10,
    images: [
      { url: '/images/amla_candy.jpg', alt: 'Sweet and Tangy Sun-Dried Amla Candy', isPrimary: true }
    ]
  },
  {
    id: 'prod-food-11',
    ...
    sortOrder: 11,
    images: [
      { url: '/images/amla_powder.jpg', alt: 'Pure Organic Herbal Amla Powder', isPrimary: true }
    ]
  },
  {
    id: 'prod-food-12',
    ...
    sortOrder: 12,
    images: [
      { url: '/images/amla_juice.jpg', alt: '100% Pure Cold-Pressed Amla Juice', isPrimary: true }
    ]
  },
  {
    id: 'prod-textile-1',

  ...
  return (
    <div className="intro-screen" id="intro-screen">
      ...
      <header className={`landing-header${scrolled ? ' landing-header--scrolled' : ''}`}>
        <div className="landing-header__inner">
          ...
          <div className="landing-header__actions">
            <a href="mailto:export@RVDHglobals.com" className="landing-header__cta">
              <span className="landing-header__cta-icon">✉</span>
              Get a Quote
            </a>
            <a
              href="https://wa.me/919877118868?text=Hello%20RVDH%20Globals%2C%20I%27m%20interested%20in%20your%20export%20products"
              target="_blank"
        ...
        {mobileNavOpen && (
          <div className="landing-header__mobile-menu">
            ...
            <button className="landing-nav__link" onClick={() => smoothScroll('intro-choose-section')}>Divisions</button>
            <button className="landing-nav__link" onClick={() => smoothScroll('intro-footer-section')}>Contact</button>
            <a href="mailto:export@RVDHglobals.com" className="landing-header__cta" style={{ alignSelf: 'flex-start', marginTop: '8px' }}>
              <span className="landing-header__cta-icon">✉</span>
              Get a Quote
            </a>
          </div>
      ...
      <div className="intro-hero">
        <div className="intro-eyebrow">RVDH Globals — International Trade House</div>
      ...
      <div id="about-us-landing" style={{ maxWidth: '1000px', margin: '0 auto 70px', padding: '0 24px' }}>
        <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,.08)', borderRadius: '20px', padding: '40px 36px', boxShadow: '0 4px 20px rgba(0,0,0,.04)' }}>
          ...
          <p style={{ fontSize: '.98rem', color: '#555', lineHeight: 1.7, marginBottom: '16px' }}>
            <strong>RVDH Globals</strong> is a premier Indian export house operating two specialized core divisions: <strong>Food Products (Makhana / Fox Nuts)</strong> and <strong>Home Textiles (Luxury Linens &amp; Hospitality Bedding)</strong>.
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px', paddingTop: '24px', borderTop: '1px solid rgba(0,0,0,.08)', fontSize: '.88rem', color: '#333' }}>
            <div>
              ...
              <div>RVDH Globals Trade House</div>
            ...
            <div>
              ...
              <div><a href="mailto:export@RVDHglobals.com" style={{ color: '#2F5233', fontWeight: 600, textDecoration: 'none' }}>export@RVDHglobals.com</a></div>
              <div><a href="mailto:sales@RVDHglobals.com" style={{ color: '#555', textDecoration: 'none' }}>sales@RVDHglobals.com</a></div>
            </div>
      ...
      <div className="intro-trust" id="intro-trust-section">
        <div className="intro-trust-head">
          <h2>Why global buyers trust RVDH Globals</h2>
          <p>
      ...
      <footer id="intro-footer-section" style={{ background: '#162544', color: '#fff', padding: '50px 0 28px', borderTop: '1px solid rgba(255,255,255,.1)' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 24px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '30px' }}>
          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
            <div>
              ...
              <a href="mailto:export@RVDHglobals.com" style={{ display: 'block', color: 'rgba(255,255,255,.8)', fontSize: '.85rem', textDecoration: 'none', marginBottom: '6px' }}>
                📧 export@RVDHglobals.com
              </a>
              <a href="mailto:sales@RVDHglobals.com" style={{ display: 'block', color: 'rgba(255,255,255,.8)', fontSize: '.85rem', textDecoration: 'none' }}>
                ✉️ sales@RVDHglobals.com
              </a>
            </div>
        ...
        <div style={{ maxWidth: '1000px', margin: '30px auto 0', padding: '20px 24px 0', borderTop: '1px solid rgba(255,255,255,.1)', fontSize: '.78rem', opacity: .55, textAlign: 'center' }}>
          © 2026 RVDH Globals — International Trade House. All rights reserved.
        </div>
      </footer>
    </div>
  );
